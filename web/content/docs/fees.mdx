...
export const meta = {
  ...
  description: "A short reference for the numbers that govern raffl: protocol fee, ticket and duration limits, gas, rent.",
...
| Prize description | ≤ 128 bytes | enforced in `create_raffle` |
